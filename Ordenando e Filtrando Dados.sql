...
SELECT StoreName, EmployeeCount FROM DimStore WHERE EmployeeCount <= 20

SELECT StoreName, EmployeeCount FROM DimStore WHERE EmployeeCount BETWEEN 21 AND 50

SELECT StoreName, EmployeeCount FROM DimStore WHERE EmployeeCount > 50
...
SELECT ProductKey, ProductName, UnitCost FROM DimProduct WHERE ProductDescription LIKE '%LCD%'
...
--SELECT * FROM DimProduct WHERE ColorName IN ('Green', 'Orange', 'Silver', 'Black', 'Pink') AND BrandName IN ('Contoso', 'Litware', 'Fabrikam')
